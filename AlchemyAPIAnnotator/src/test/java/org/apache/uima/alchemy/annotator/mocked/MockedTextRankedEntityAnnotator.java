 ...
 */
public class MockedTextRankedEntityAnnotator extends TextRankedNamedEntityExtractionAnnotator {

  private static final String path = "/rankedEntityExtractionResult.xml";
